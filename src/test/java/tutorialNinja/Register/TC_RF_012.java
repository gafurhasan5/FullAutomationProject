...
public class TC_RF_012 {
	...
	public void verifyRegisteringAccountUsingKeyboarkey() {
		...
		/*actions.sendKeys("gafur").pause(Duration.ofSeconds(1))
			...
			.sendKeys(Keys.TAB).pause(Duration.ofSeconds(1)).sendKeys("hassan").sendKeys(Keys.TAB)
				.pause(Duration.ofSeconds(1)).sendKeys("Motoori").sendKeys(Keys.TAB).pause(Duration.ofSeconds(1))
